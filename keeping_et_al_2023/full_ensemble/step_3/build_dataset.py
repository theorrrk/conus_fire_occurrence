...
def build_dataset(variables, thresh_row):
    ...
    for var in variables + ['fire', 'cell_area']:
        ...
        if counter == 1:
            ...
            ds = xr.merge([ds, temp], compat = 'override')
        del temp
    # Building test-train:
    ...
    for param in params.keys():
        if param == 'Intercept':
            ...
            print(param)
            sys.stdout.flush()
            temp = ds[param].clip(min = float(thresh_row.loc['lo_' + param]),
